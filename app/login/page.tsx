    ...
    <div className="min-h-screen bg-background flex">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Sign in to access your GPU instances
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center py-3 px-4 rounded-lg border border-input bg-background hover:bg-accent"
              >
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 via-pink-500/20 to-red-500/20 items-center justify-center p-12">
        <div className="max-w-md text-center">
          <h3 className="text-3xl font-bold mb-4">GPU Cloud Made Simple</h3>
          <p className="text-muted-foreground mb-8">
            Access enterprise-grade NVIDIA GPUs in minutes. Pay only for what you use with transparent pricing.
          </p>
          <div className="grid grid-cols-2 gap-4 text-left">
            <div className="p-4 rounded-lg bg-card/50 backdrop-blur">
              <div className="text-2xl font-bold text-primary">$100</div>
              <div className="text-sm text-muted-foreground">Free credits for new users</div>
            </div>
            <div className="p-4 rounded-lg bg-card/50 backdrop-blur">
              <div className="text-2xl font-bold text-primary">&lt;60s</div>
              <div className="text-sm text-muted-foreground">Instance deployment</div>
            </div>
            <div className="p-4 rounded-lg bg-card/50 backdrop-blur">
